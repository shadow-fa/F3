...
f_var_groupData_blufor_nato = [
	...
	["GrpNATO_CAS1",   _pla, "CAS1",   "ColorRed",     "NATO CAS1 -"],
...
f_var_groupData_blufor_fia = [
	...
	["GrpFIA_CAS1",    _pla, "CAS1",   "ColorRed",     "FIA CAS1 -"],
...
f_var_groupData_opfor_csat = [
	...
	["GrpCSAT_CAS1",   _pla, "CAS1",   "ColorRed",     "CSAT CAS1 -"],
...
f_var_groupData_opfor_fia = [
	...
	["GrpOFIA_CAS1",   _pla, "CAS1",   "ColorRed",     "FIA O CAS1 -"],
...
f_var_groupData_indfor_aaf = [
	...
	["GrpAAF_CAS1",    _pla, "CAS1",   "ColorRed",     "AAF CAS1 -"],
...
f_var_groupData_indfor_fia = [
	...
	["GrpIFIA_CAS1",   _pla, "CAS1",   "ColorRed",     "FIA I CAS1 -"],
...
f_var_groupData_indfor_syn = [
	...
	["GrpSyn_CAS1",    _pla, "CAS1",   "ColorRed",     "Syndikat CAS1 -"],
